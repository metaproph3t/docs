...
description: "Why should someone launch their project on MetaDAO? And why should they not?"
---
...
The main risks to you are the risks that come from having a token:

- It can go down
- It’s generally harder to sell liquid tokens than it is to sell token warrants[2]
- People will be annoyed at you when the token goes down

There are also risks around MetaDAO itself:

- If your token price dips below book value, proposals to return capital to tokenholders via buybacks or liquidation are likely to pass
- Manipulation could be a bigger issue than we’ve seen over the last 18 months
- We could have a smart contract exploit

---
title: "Tokens today are broken"
---

**Internet capital markets are a 0 to 1 innovation.** When tokenized, an enterprise:
- Can make its early customers and believers into owners
- Can use tokens to incentivize adoption and bootstrap network effects
- Has a feedback loop between its actions and its price chart
- Can offer liquidity earlier than the 7-10 years common in Silicon Valley

See Bitcoin, Ethereum, Solana, or Hyperliquid as examples of the grassroots
community support projects can see when they execute a token well.
...
- Create a DAO and separate "Labs" and "Foundation" entities
...
Front-loaded demand (from your TGE hype) and back-loaded supply (the vest) means that prices generally collapse over time. And when this happens, “the community” starts feeling less like a community and more like an angry mob.

Platforms like Echo and Legion allow regular people to participate in those early funding rounds but they don’t improve the core problem: the supply 3-10xing over time.
...
**Rugs like these have led to most investors, especially serious ones, being wary of ICOs.**
